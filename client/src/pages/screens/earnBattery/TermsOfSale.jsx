    ...
    <div className="text-left container">
      ...
      <section>
        ...
        <div>
          <p>
            ...
            ehandelsloven, og disse lovene gir forbrukeren ufravikelige
            rettigheter. Lovene er tilgjengelig på{" "}
            <a target="_blank" href="http://www.lovdata.no/" rel="noopener">
              www.lovdata.no.
            </a>{" "}
          ...
          <p>
            ...
            <a href="https://forbrukertilsynet.no/lov-og-rett/veiledninger-og-retningslinjer/veiledning-standard-salgsbetingelser-forbrukerkjop-varer-internett">
      ...
      <section>
        ...
        <div>
          ...
          <ul>
            <li>
              Ved kjøp av enkeltstående varer vil angrefristen løpe fra dagen
          ...
          <p>
            ...
            næringsdrivende for å gi opplysningene i løpet av disse 12 månedene,
            utløper angrefristen likevel 14 dager etter den dagen kjøperen
          ...
          <p>
            ...
            er gitt. Kjøper dekker de direkte kostnadene ved å returnere varen,
            med mindre annet er avtalt eller selger har unnlatt å opplyse om at
            kjøper skal dekke returkostnadene. Selgeren kan ikke fastsette gebyr
            for kjøperens bruk av angreretten.
          </p>
          <p>
      ...
      <section>
        ...
        <div>
          <p>
            ...
            i forbrukerkjøpslovens kapittel 5 etter omstendighetene{" "}
            <em>holde kjøpesummen tilbake</em>, kreve <em>oppfyl</em>
            <em>lelse</em>, <em>heve </em>avtalen og/eller kreve{" "}
            <em>erstatning </em>fra selgeren.
          </p>
          <p>
          ...
          <p>
            ...
            avtalen, må krav om heving gjøres gjeldende innen rimelig tid etter
      ...
      <section>
        ...
        <div>
          <p>
            ...
            er ment å vare vesentlig lenger enn to år, er reklamasjonsfristen
            fem år.
          </p>
          <p>
            ...
            forbrukerkjøpsloven kapittel 6 etter omstendighetene{" "}
            <em>holde kjøpesummen tilbake</em>, velge mellom <em>retting </em>og{" "}
            <em>omlevering</em>, kreve <em>prisavslag</em>, kreve avtalen hevet
            og/eller kreve <em>erstatning&nbsp; </em>fra selgeren.
          </p>
      ...
      <section>
        ...
        <div>
          <p>
            ...
            forbrukerkjøpsloven kapittel 9 etter omstendighetene <em>holde</em>{" "}
            <em>varen tilbake</em>, kreve <em>oppfyllelse </em>av avtalen, kreve
            avtalen <em>hevet </em>samt kreve <em>erstatning </em>fra kjøperen.
            Selgeren vil også etter omstendighetene kunne kreve{" "}
            <em>renter ved forsinket betaling, inkassogebyr</em> og et rimelig{" "}
          ...
          <p>
            ...
            &nbsp;utlegg for å levere varen til kjøperen. Et slikt gebyr kan
      ...
      <section>
        ...
        <div>
          <p>
            ...
            dette ikke lykkes, kan kjøperen ta kontakt med Forbrukerrådet for
            mekling. Forbrukerrådet er tilgjengelig &nbsp;på &nbsp;telefon
            23&nbsp; 400&nbsp; 500&nbsp; eller{" "}
            <a
              target="_blank"
          ...
          <p>
            ...
            inngi en klage. Det er særlig relevant, hvis du er forbruker bosatt
            i et annet EU-land. Klagen inngis her:&nbsp;
