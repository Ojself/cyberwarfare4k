...
const HackerProfile = props => {
  ...
  const opponentGlobalRanking = (
    !opponentState.loading && (
    <div className="col-3 ">
      <ListGroup className="text-left">
        <ListGroupItem className="justify-content-between bg-dark text-center"> <strong>{opponentState.opponent.name}'s <span style={{ color: "#FFCC00" }}>global ranking</span> </strong></ListGroupItem>
        <ListGroupItem className="justify-content-between bg-dark"><Badge pill>{opponentState.ranking.crimeSkill}</Badge> Crime skills </ListGroupItem>
        <ListGroupItem className="justify-content-between bg-dark"><Badge pill>{opponentState.ranking.hackSkill}</Badge> Hack Skills </ListGroupItem>
        <ListGroupItem className="justify-content-between bg-dark"><Badge pill>{opponentState.ranking.networth}</Badge> Networth </ListGroupItem>
        <ListGroupItem className="justify-content-between bg-dark"><Badge pill>{opponentState.ranking.shutdowns}</Badge> Shutdowns </ListGroupItem>
    </ListGroup>
    </div>
  ))
