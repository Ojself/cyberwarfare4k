...
const Tutorial = ({ section, color, size }) => {
  ...
  const defaultColor = color ? color : "info";
  ...
  const iconStyle = { cursor: "pointer", fontSize: sizes[size] };
    ...
    !userHasDeactivated && (
      <>
        <i
          style={iconStyle}
          onClick={toggle}
          className={`far fa-question-circle text-${defaultColor} pt-3`}
        ></i>
