  ...
  render() {
    return (
      <div>
        ...
        <div>
          <p>
            <strong>HOME</strong>: Here you can find a general overview about
          ...
          <p>
            <span>BATTERY</span>: Indicates your stamina. Battery of your
            computer will decrease as you perform actions. It will recharge 10%
          ...
          <p>
            ...
            Hacking you do, the more EXP you will get. For each milestone,
            you'll get a new Rank.{' '}
          </p>
          ...
          <p>
            {' '}
            <strong>RANK</strong>: Indicates your level of experience as a
            hacker. This symbolize status more than anything else.
          </p>

          <p>
            <strong>CRIMES</strong>: Here you can conduct various kinds of
            crimes. If you succeed in your crime, you'll be granted some
            Bitcoins and EXP for the effort. The easiest ones are on top and the
            most difficult are at the bottom.{' '}
          </p>

          <p>
            {' '}
            <strong>HACK PLAYER</strong>: Here you can attack other players by
            hacking them. Every stat, except Crime Skill, will affect the
            outcome of the attack. If you succeed, you'll steal some of the
            opponents bitcoins, as well as lowering his Firewall. Regardless of
            the outcome, your battery will lower.{' '}
          </p>

          <p>
            <strong>EVENTS</strong>: Shows you the latest events that has
            happend to your character.
          </p>

          <p>
            <strong>WANTED LIST</strong>: In the Wanted List you can add bounty
            on other players head, as well as being able to see which player
            already having a bounty on his head. You can collect this by hacking
            them until their Firewall is 0.{' '}
          </p>
          ...
          <p>
            ...
            new equipment for your computer. You can only hold one item from
            each group: cpu, avs, firewall, encryption.
          </p>

          <p>
            <strong>SYSTEM REPAIR</strong>: The system repair allows you to fix
            up your computer for a relatively small fee. Choose between a quick
            fix or a full repair.
          </p>
