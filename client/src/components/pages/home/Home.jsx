...
<blockquote class="blockquote text-center">
  <p class="mb-0">{hackerComments[Math.floor(Math.random()*hackerComments.length)]}.</p>
  <footer class="blockquote-footer">{hackerNames[Math.floor(Math.random()*hackerNames.length)]} ({randomYear})</footer>
</blockquote>
  ...
  return ( 
    ...
    <div className="d-flex flex-row justify-content-center">
      ...
      <iframe style={{'margin':'50px'}}  width="560" title="ncis" height="315" src="https://www.youtube.com/embed/K7Hn1rPQouU" frameBorder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen={true}></iframe>
      
      <iframe style={{'margin':'50px'}} width="560" title="hacking" height="315" src="https://www.youtube.com/embed/pF-3S-HTJSg" frameBorder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen={true}></iframe>
      </div>
