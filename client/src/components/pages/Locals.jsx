  ...
  return (
    <div>
      ...
      <Table striped dark>
        ...
        <tbody>
          {localState.loading?null:localState.cityLocals.residents.map((user, i) => (
            <tr key={user._id}>

              <th scope="row">
                <NavLink href={`/hacker/${user._id}`}> {checkIfOnline("5dd92c85dbffb976e3c59ef1")&&  <FontAwesomeIcon icon={faWifi} /> }{" "}{user.name}</NavLink>
              </th>
