...
const dataCenterSeeds = async () => {
  await DataCenter.deleteMany();
  let dataCentersCreated;
  try {
    dataCentersCreated = await DataCenter.create(dataCenters);
  } catch (err) {
    console.err('Datacenter seeds error: ', err);
    throw err;
  }
  console.info(dataCentersCreated.length, 'datacenters created');
};
module.exports = { dataCenterSeeds };
